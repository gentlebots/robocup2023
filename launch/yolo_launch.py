...
def generate_launch_description():
    ...
    yolo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(yolo_dir, 'yolov8.launch.py')),
        launch_arguments={'input_image_topic': '/camera/color/image_raw'}.items())  # change to /xtion/rgb/image_raw

    perception_3d = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(perception_dir, 'yolov8.launch.py')),
